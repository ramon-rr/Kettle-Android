...
public class PostViewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        PostInfo pi = (PostInfo) getArguments().getSerializable("VIEW_POST");
        TextView title = view.findViewById(R.id.postViewTitle);
        TextView body = view.findViewById(R.id.postViewBody);
        title.setText(pi.getTitle());
        body.setText(pi.getBody());
        return view;
    }
}